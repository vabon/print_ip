...
template <typename T>
void print_ip(const typename std::enable_if<std::is_integral<T>::value, T>::type & ip)
{
...
template<typename T>
void print_ip(const typename std::enable_if<std::is_compound<T>::value, T>::type & ip)
{
